...
static const char *colors[][3]      = {
    ...
    [SchemeTag12]      = { red,     black,  black },
    [SchemeTag13]      = { orange,  black,  black },
    [SchemeTag14]      = { green,   black,  black },
    [SchemeTag15]      = { pink,    black,  black },
    [SchemeTag16]      = { blue,    black,  black },
    [SchemeTag17]      = { red,     black,  black },
    [SchemeTag18]      = { orange,  black,  black },
    [SchemeTag19]      = { green,   black,  black },
...
/* tagging */
static char *tags[] = {"1", "2", "3", "4", "5", "6", "7", "8", "9", "", "", "󰘨", "󰖂", "", "󱔗", "󰭹", "", "", ""};
...
static const int tagschemes[] = {
    SchemeTag1, SchemeTag2, SchemeTag3, SchemeTag4, SchemeTag5, SchemeTag6, SchemeTag7, SchemeTag8, SchemeTag9, SchemeTag10, SchemeTag11, SchemeTag12, SchemeTag13, SchemeTag14, SchemeTag15, SchemeTag16, SchemeTag17, SchemeTag18, SchemeTag19
};
...
static const Key keys[] = {
  ...
  //{0,                       XF86XK_AudioLowerVolume, spawn, {.v = downvol}},
    ...
    { 0,                   XF86XK_AudioRaiseVolume, spawn,          SHCMD("pamixer -i 5; notify-send -r 9992 -u low '' 'Volume is at $(pamixer --get-volume)%.'")},
    { 0,                   XF86XK_AudioLowerVolume, spawn,          SHCMD("pamixer -i 5; notify-send -r 9992 -u low '' 'Volume is at $(pamixer --get-volume)%.'")},
	  {0,                    XF86XK_AudioMute,        spawn,          SHCMD("pamixer -t; notify-send -r 9992 -u low '' 'Volume mute toggled.'"),
    ...
    { MODKEY|ShiftMask,                 XK_p,       spawn,          SHCMD("/home/ahwx/.config/rofi/powermenu/powermenu")},
